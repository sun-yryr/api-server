...
router.post('/', async function(req, res, next) {
    ...
    /*データの登録 */
    var db_res =await shiori.dbAccess('INSERT INTO records (user_id,book_id,user_name,star,impression,readtime,readspeed,creted_date) VALUES (user_id,book_id,user_name,star,impression,readtime,readspeed,creted_date)');
    res.status(200);
});
